...
public class IAPartialModels {
    ...
    BLAZE_FREEZER_ACTIVE_HEAD = block("breeze_freezer_active_head"),
    BLAZE_FREEZER_IDLE_HEAD = block("breeze_freezer_idle_head"),
    BLAZE_FREEZER_INERT_HEAD = block("breeze_freezer_inert_head"),
    BLAZE_FREEZER_RODS_BIG = block("frozen_rods_large"),
    BLAZE_FREEZER_RODS_SMALL = block("frozen_rods_small"),
    BLAZE_FREEZER_FLAME = block("super_flame");
