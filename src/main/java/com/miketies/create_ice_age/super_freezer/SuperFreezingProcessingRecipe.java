...
public abstract class SuperFreezingProcessingRecipe<T extends Container> implements Recipe<T> {
    ...
    public SuperFreezingProcessingRecipe(IRecipeTypeInfo typeInfo, SuperFreezingRecipeBuilder.ProcessingRecipeParams params) {
