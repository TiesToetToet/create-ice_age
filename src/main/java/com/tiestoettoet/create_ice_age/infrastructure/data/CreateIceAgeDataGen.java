...
public class CreateIceAgeDataGen {

    public static void gatherDataHighPriority(GatherDataEvent event) {
        if (event.getMods().contains(CreateIceAge.MOD_ID))
...
//        generator.addProvider(event.includeClient(), new CreateWikiBlockInfoProvider(output));
    ...
    private static void addExtraRegistrateData() {
        ...
        CreateIceAge.registrate().addDataGenerator(ProviderType.LANG, provider -> {
...
//            new TagLangGenerator(langConsumer).generate();
    ...
    private static void provideDefaultLang(String fileName, BiConsumer<String, String> consumer) {
        String path = "assets/create_ice_age/lang/default/" + fileName + ".json";
