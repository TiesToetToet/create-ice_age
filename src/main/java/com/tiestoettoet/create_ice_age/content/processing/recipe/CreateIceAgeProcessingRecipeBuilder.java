...
public abstract class CreateIceAgeProcessingRecipeBuilder<P extends CreateIceAgeProcessingRecipeParams, R extends CreateIceAgeProcessingRecipe<?, P>, S extends CreateIceAgeProcessingRecipeBuilder<P, R, S>> {
    protected ResourceLocation recipeId;
    protected CreateIceAgeProcessingRecipe.Factory<P, R> factory;
    protected P params;
    protected List<ICondition> recipeConditions;

    public CreateIceAgeProcessingRecipeBuilder(CreateIceAgeProcessingRecipe.Factory<P, R> factory, ResourceLocation recipeId) {
    ...
    public S requiresFreeze(FreezeCondition condition) {
        params.requiredFreeze = condition;
        return self();
    }
    ...
    public void build(RecipeOutput consumer) {
        ...
        if (!errors.isEmpty()) {
            ...
            CreateIceAge.LOGGER.warn(Joiner.on('\n').join(errors));
        }
