...
public abstract class CreateIceAgeProcessingRecipe<I extends RecipeInput, P extends CreateIceAgeProcessingRecipeParams> implements Recipe<I> {
    ...
    public CreateIceAgeProcessingRecipe(IRecipeTypeInfo typeInfo, P params) {
        this.params = params;
        ...
        this.requiredFreeze = params.requiredFreeze;
    ...
    protected boolean canRequireFreeze() {
        return false;
    }
    ...
    public List<String> validate() {
        ...
        if (requiredFreeze != FreezeCondition.NONE && !canRequireFreeze())
            errors.add("Recipe specified a freeze condition. Freeze conditions have no impact on this type of recipe.");
    ...
    public FreezeCondition getRequiredFreeze() {
    ...
    public static <P extends CreateIceAgeProcessingRecipeParams, R extends CreateIceAgeProcessingRecipe<?, P>> MapCodec<R> codec(
            CreateIceAgeProcessingRecipe.Factory<P, R> factory, MapCodec<P> paramsCodec
    ) {
    ...
    public static <P extends CreateIceAgeProcessingRecipeParams, R extends CreateIceAgeProcessingRecipe<?, P>> StreamCodec<RegistryFriendlyByteBuf, R> streamCodec(
            CreateIceAgeProcessingRecipe.Factory<P, R> factory, StreamCodec<RegistryFriendlyByteBuf, P> streamCodec
    ) {
        return streamCodec.map(factory::create, CreateIceAgeProcessingRecipe::getParams);
    }

    @FunctionalInterface
    public interface Factory<P extends CreateIceAgeProcessingRecipeParams, R extends CreateIceAgeProcessingRecipe<?, P>> {
        R create(P params);
    }
}