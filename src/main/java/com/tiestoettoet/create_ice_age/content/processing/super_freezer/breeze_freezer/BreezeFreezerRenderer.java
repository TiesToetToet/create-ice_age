...
public class BreezeFreezerRenderer extends SafeBlockEntityRenderer<BreezeFreezerBlockEntity> {

    public BreezeFreezerRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    protected void renderSafe(BreezeFreezerBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource bufferSource,
...
//        PartialModel drawHat = be.hat ? com.simibubi.create.AllPartialModels.TRAIN_HAT : be.stockKeeper ? com.simibubi.create.AllPartialModels.LOGISTICS_HAT : null;
    ...
    public static void renderInContraption(MovementContext context, VirtualRenderWorld renderWorld,
        ...
        FreezingLevel freezingLevel = BreezeFreezerBlock.getFreezeLevelOf(state);
        if (freezingLevel == FreezingLevel.NONE)
            return;
    ...
    public static void renderShared(PoseStack ms, @Nullable PoseStack modelTransform, MultiBufferSource bufferSource,
        ...
        var breezeModel = getBlazeModel(freezingLevel, blockAbove);
        ...
        if (drawGoggles) {
            PartialModel gogglesModel = breezeModel == AllPartialModels.FREEZE_INERT
                    ? AllPartialModels.BREEZE_GOGGLES_SMALL : AllPartialModels.BREEZE_GOGGLES;
        ...
        if (canDrawFlame && blockAbove) {
            ...
            SuperByteBuffer flameBuffer = CachedBuffers.partial(AllPartialModels.BREEZE_FREEZER_FLAME, blockState);
            if (modelTransform != null)
