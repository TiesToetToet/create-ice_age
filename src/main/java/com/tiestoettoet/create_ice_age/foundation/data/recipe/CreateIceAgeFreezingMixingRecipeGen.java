...
public class CreateIceAgeFreezingMixingRecipeGen extends FreezingMixingRecipeGen {
    GeneratedRecipe
...
//            .requiresFreeze(FreezeCondition.SUPER_FREEZING)),
    ...
    POWDER_SNOW = create("powder_snow", b -> b.require(AllFluids.LIQUID_ICE.get(), 1000)
            .output(AllFluids.POWDER_SNOW.get(), 1000)
            .requiresFreeze(FreezeCondition.SUPER_FREEZING))
    ...
    public CreateIceAgeFreezingMixingRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
