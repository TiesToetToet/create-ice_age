package com.tiestoettoet.create_ice_age.foundation.ponder;
...
import com.tiestoettoet.create_ice_age.infrastructure.ponder.AllCreateIceAgePonderScenes;
import net.createmod.ponder.api.level.PonderLevel;
import net.createmod.ponder.api.registration.*;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.world.item.DyeColor;

public class CreateIceAgePonderPlugin implements PonderPlugin {
    @Override
    public String getModId() {
        return CreateIceAge.MOD_ID;
    }

    @Override
    public void registerScenes(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        AllCreateIceAgePonderScenes.register(helper);
    }
