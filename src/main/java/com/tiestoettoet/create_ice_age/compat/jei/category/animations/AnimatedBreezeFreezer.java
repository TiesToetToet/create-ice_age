...
public class AnimatedBreezeFreezer extends AnimatedKinetics {
    ...
    public void draw(GuiGraphics graphics, int xOffset, int yOffset) {
        ...
        blockElement(AllBlocks.BREEZE_FREEZER.getDefaultState()).atLocal(0, 1.65, 0)
                .scale(scale)
                .render(graphics);

        PartialModel breeze =
                freezingLevel == BreezeFreezerBlock.FreezingLevel.SUPER_FREEZING ? AllPartialModels.FREEZE_SUPER : AllPartialModels.FREEZE_ACTIVE;
        PartialModel rods2 = freezingLevel == BreezeFreezerBlock.FreezingLevel.SUPER_FREEZING ? AllPartialModels.BREEZE_FREEZER_SUPER_RODS_2
                : AllPartialModels.BREEZE_FREEZER_RODS_2;

        blockElement(breeze).atLocal(1, 1.8, 1)
                .rotate(0, 180, 0)
                .scale(scale)
                .render(graphics);
        ...
        SpriteShiftEntry spriteShift =
                freezingLevel == BreezeFreezerBlock.FreezingLevel.SUPER_FREEZING ? AllSpriteShifts.SUPER_FREEZER_FLAME : AllSpriteShifts.FREEZER_FLAME;
        ...
        CachedBuffers.partial(AllPartialModels.BREEZE_FREEZER_FLAME, Blocks.AIR.defaultBlockState())
